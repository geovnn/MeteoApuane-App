...
data class HomePage(
    ...
    val imgAllerta2: String = "",
    val imgAllerta3: String = "",
    val imgAllerta4: String = "",
    val imgAllerta5: String = "",
    val imgAllerta6: String = "",
    val txtAvviso: String = "",
    val imgUltimora1: String = "",
    val txtUltimoraTitle1: String = "",
    val txtUltimoraBody1: String = "",
    val imgUltimora2: String = "",
